...
**Type:** Personal tool
**Stack:** Vue 3, TypeScript, Vite, TipTap
**Links:** [Live](https://simplepad.patriarxis.com) · [GitHub](https://github.com/patriarxis/simplepad)

Offline-first drafts on a single device: rich editing, Markdown shortcuts, syntax-highlighted code, and a source toggle. No accounts, sync, or server copies.

[Open project →](/#/projects/simplepad)
