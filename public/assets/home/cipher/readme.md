...
Generate with the Web Crypto API, read an entropy-based strength meter, and keep a short local history. Preferences stay in `localStorage` — no server, no analytics path for passwords.

[Open project →](/#/projects/cipher)
