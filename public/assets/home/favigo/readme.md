...
A last-check tool for favicons: compare sizes on light and dark frames, preview a tab mock, and swap the live page favicon while a file is selected.

[Open project →](/#/projects/favigo)
