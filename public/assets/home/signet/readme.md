...
| **Type** | Personal tool |
| **Stack** | Vue 3, TypeScript, Vite, CodeMirror 6 |
| **Links** | [Live](https://signet.patriarxis.com) · [GitHub](https://github.com/patriarxis/signet) |

Browse table-based templates, edit shared fields, tweak formatting, then copy sanitized HTML. Everything stays on the device — no accounts or cloud sync.

[Open project →](/#/projects/signet)
